...
class Name(object):
    @classmethod
    def get(self):
        return " ".join([random.choice(first_names), random.choice(surnames)])


first_names = ["Abigayl", "Aebria", "Aeobreia", "Breia", "Aedria", "Aodreia", "Dreia", "Aeliya", "Aliya",
...
surnames = ["Bright", "Brown", "Browne", "Brushfire", "Camp", "Campman", "Canyon", "Cricketts", "Crickets",
